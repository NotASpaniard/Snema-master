    ...
    <main class="main-content">
        <div class="container-fluid">
            <div class="page-header d-flex justify-content-between align-items-center mb-4">
                <h1 class="page-title">Sửa thông tin phòng chiếu</h1>
            ...
            <div class="col-mb-3 md-4">
                <form method="post" action="{{ route('rooms.update', $room->id) }}">
                    ...
                    <table class="table table-bordered" style="width: 100%;">
                        ...
                        <tr>
                            <td>Số phòng</td>
                            <td><input type="text" name="room_number" value="{{ $room->room_number }}" required></td>
                        </tr>

                        <tr>
                            <td>Số lượng ghế</td>
                            <td><input type="number" name="total_seat" value="{{ $room->total_seat }}" required></td>
                        </tr>
                    ...
                    <button type="submit" class="btn btn-success">Sửa phòng chiếu</button>
