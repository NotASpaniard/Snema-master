...
<div id="slideBox">
    <div class="topLayer">
        <div style="scrollbar-width: none;" class="left">
            <div class="content">
                <h2>Đăng ký</h2>
                <form id="form-signup" method="POST" action="{{ route('customers.store') }}">
                    @csrf
                    <div class="form-element form-stack">
                        <label for="username-signup" class="form-label">Họ và tên</label>
                        <input id="username-signup" type="text" name="name">
                    </div>
                    <div class="form-element form-stack">
                        <label for="username-signup" class="form-label">Giới tính</label>
                        <select name="gender">
                    ...
                    <div class="form-element form-stack">
                        <label for="username-signup" class="form-label">Ngày sinh</label>
                        <input id="username-signup" type="date" name="birth_date">
                    </div>
                    <div class="form-element form-stack">
                        <label for="username-signup" class="form-label">Số điện thoại</label>
                        <input id="username-signup" type="text" name="phone_number">
                    </div>
                    <div class="form-element form-stack">
                        <label for="username-signup" class="form-label">Email</label>
                        <input id="username-signup" type="text" name="email">
                    </div>
                    <div class="form-element form-stack">
        ...
        <div style="scrollbar-width: none;" class="right">
            <div class="content">
                <h2>Login</h2>
                <form id="form-login" method="POST" action="{{ route('customers.loginProcess') }}">
                    @csrf
                    <div class="form-element form-stack">
