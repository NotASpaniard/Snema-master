...
<div class="admin-container">
    ...
    <main class="main-content">
        ...
        <div class="col-md-3 mb-4">
            <form action="{{ route('snacks.update', $snack->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <table class="table table-bordered" style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="name" class="form-control" value="{{ old('name', $snack->name)  }}" required></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($snack->image)
                                <img src="{{ asset('storage/' . $snack->image) }}" alt="Poster" width="100" class="mb-2"><br>
                            @endif
                    ...
                    <tr>
                        <td>Mô tả</td>
                        <td><input type="text" name="description" class="form-control" value="{{ old('description', $snack->description)  }}" required></td>
                    </tr>
                    ...
                    <tr>
                        <td>Đơn giá</td>
                        <td><input type="number" name="price" class="form-control" value="{{ old('price', $snack->price)  }}" required></td>
                    </tr>

                    <tr>
                        <td colspan="2" class="text-center">
                            <button type="submit" class="btn btn-primary">Cập nhật snack</button>
                        </td>
                    </tr>
                </table>
            </form>
