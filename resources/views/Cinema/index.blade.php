    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <button class="btn btn-primary">
                <i class="fas fa-plus"></i> <a href="{{ route('cinemas.create') }}" style="color: white">Thêm rạp</a>
            </button>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="{{ route('cinemas.edit', $cinema->id) }}" class="btn btn-warning">Sửa</a>
                                <form action="{{ route('cinemas.destroy', $cinema->id) }}" method="POST" onsubmit="return confirm('Xác nhận xoá?')">
                                    @csrf
                                    @method('DELETE')
